          ...
          <div className={`${styles.content} ${styles.revealItem}`}>
            ...
            <div className={styles.textBlock}>
              <p className={styles.paragraph}>
                ...
                <strong>התשוקה הזו לדיוק ולטבעיות</strong> גרמה לי להבין שיש לי יכולת לראות בדיוק מה כל אישה צריכה - בגבות, בשפתיים, בריסים.
              </p>

              <div className={styles.divider}></div>

              <p className={styles.paragraph}>
                היום, אחרי עשור בתחום, אני כאן כדי להקשיב לצרכים שלך, להוציא אותך ממני בגרסה הכי יפה של עצמך,
              ...
              <p className={styles.paragraph}>
                אני מבינה את הפחדים שלך, את החששות שלך, ואת החלום שלך להיראות טבעית ויפה.
                כל טיפול מותאם אישית, כי לא כל שיטה מתאימה לכל אחת - <strong>ואני כאן לוודא שתקבלי בדיוק מה שמתאים לך</strong>.
              </p>

              <p className={styles.finalText}>
                כי כל אישה מגיע לה להרגיש יפה ובטוחה – עם תוצאה טבעית שמתאימה בדיוק לה.
              </p>
            </div>

    ...
    <div className={styles.container}>
     ...
     <div className={styles.description}>
      ...
      <div className={styles.contentSection}>
        <h2 className={styles.sectionTitle}>מה זה בעצם מיקרוטאצ׳?</h2>
      ...
      <div className={styles.contentSection}>
        <h3 className={styles.sectionSubtitle}>למי זה מתאים?</h3>
        <div className={styles.suitableList}>
          <ul>
            <li>למי שכבר עשתה שיקום גבות ורק צריכה חיזוקים ספציפים והשלמות עדינות.</li>
            <li>למי שיש בסיס יפה של גבות אבל יש חורים קטנים או אזורים דלילים.</li>
            <li>למי שרוצה להיראות טבעית ומסודרת מבלי למלא את הגבות באופן נקודתי כל פעם בעצמה.</li>
          </ul>
        </div>
      </div>
